...
export const jsonResume :string = `
{
  "about": {
    ...
    "bio": "Accomplished engineer and technical leader with a proven track
            record of delivering scalable solutions across global organizations.
            Expert in designing, building, deploying, and maintaining systems
            that cater to millions of users. Experienced in developing and
            leading teams, fostering a collaborative and high-performing
            environment. Adept at managing roadmaps and facilitating seamless
            communication between engineering teams and other stakeholders on a
            global scale. Skilled in identifying process deficiencies,
            establishing metrics to evaluate those processes, and relentlessly
            iterating to drive improvements. Highly proficient in Agile
            methodologies, adept at running sprints, backlog grooming,
            retrospectives, and standups to ensure efficient project
            management."
    "skills": {
